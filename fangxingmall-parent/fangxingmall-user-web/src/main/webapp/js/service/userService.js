...
app.service('userService',function($http){
	...
	//增加 
	this.addByEmail=function(entity,emailcode){
		return  $http.post('../user/addByEmail.do?emailcode='+emailcode,entity );
	}
	//修改 
	...
	this.sendEmailCode=function(email){
		return $http.get('../user/sendEmailCode.do?email='+email);
	}
